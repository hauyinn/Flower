...
public class viewtable extends javax.swing.JFrame {
    ...
    public ArrayList<Customer> customerList(){
        ...
        try{
            String host ="jdbc:derby://localhost:1527/customerdb";
            ...
            while(rs.next()){
                customer = new Customer(rs.getString("invoiceid"),rs.getDouble("amount"),rs.getString("Status"),rs.getString("Time"));
